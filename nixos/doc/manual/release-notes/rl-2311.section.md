...
- The [PAM module for libpwquality](https://github.com/libpwquality/libpwquality/) is available for use. One can configure it using the `security.pam.pwquality`` options.
